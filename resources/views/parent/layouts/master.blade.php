  ...
  <nav style="background-color:#401f5c"  class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a style="color: white" href="{{route('parent.dashboard')}}" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
    ...
    <ul class="navbar-nav ml-auto">
     ...
     <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <a href="{{ route('parent.profiles.view') }}" class="dropdown-item">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
         <img class="profile-user-img img-fluid img-circle"
                       src="{{(!empty(Auth::user()->image))?url('public/upload/parentimage/'.Auth::user()->image):url('public/upload/usernoimage.png')}}"
