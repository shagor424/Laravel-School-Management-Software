            ...
            <div class="panel-header " style="background-color: #7e3796;color: white;font-size: 16px;padding: 10px;font-weight: bolder;">My Profile</div>
              <div class="panel-body box-profile" style="margin: 20px">
                <div class="text-center">
                  ...
                  <img class="profile-user-img img-fluid img-circle" src="{{(empty($user->image))?url('public/upload/parentimage/'.$user->image):url('public/upload/userimage.png')}}" alt="User profile picture">
              ...
              <div class="panel-body" style="margin:20px">
                ...
                <p class="text-muted">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam fermentum enim neque.</p>
                  ...
                  <div class="tab-pane active" id="timeline">
                    <!-- The timeline -->
                     <form class="form-horizontal" method="POST" action="{{ route('parent.profiles.update') }} " enctype="multipart/form-data">
                      @csrf
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            ...
                            <img id="showimage" src="{{(empty($user->image))?url('public/upload/parentimage/'.$user->image):url('public/upload/userimage.png')}}"
                  ...
                  <div class="tab-pane" id="settings">
                     <form method="post" action="{{route('parent.profiles.password.update')}}" id="myform">
                     @csrf
