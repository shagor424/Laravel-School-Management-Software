           ...
           <div class="card">
              <div class="card-header" style="background-color:   #f1c40f  ">
                <h5>  Invoice Approve List
                  ...
                  <a  href="{{route('payments.student.pendinglist')}}" class="btn btn-primary btn-sm float-right"><i class="fa fa-list"> Invoice Pending List</i></a>
                    ...
                    @endif
                      ...
                      <td style="text-align: center;">
                          <a href="{{route('payments.student.allview',$invoice->id)}}" class="btn btn-primary btn-xs"  title="Show All Data"> <i class="fa fa-eye"></i></a>
                           <a href="{{route('payments.student.idbypdf',$invoice->id)}}" target="_blank" class="btn btn-secondary btn-xs"  title="Show All Data"> <i class="fa fa-print"></i></a>
                            @if($invoice->status==0)
                          <a href="{{route('payments.student.delete',$invoice->id)}}" class="btn btn-danger btn-xs" id="delete" style="Delete Data"> <i class="fa fa-trash"></i></a>
                          @endif
                      </td> 
                    </tr>
                    @endforeach 
