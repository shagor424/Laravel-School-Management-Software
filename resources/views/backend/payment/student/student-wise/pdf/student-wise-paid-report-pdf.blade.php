...
<html lang="en">
  ...
  <!-- Theme style -->
    ...
    <title>Individual Student Payment Paid Repoet</title>
  </head>
  <body>
 <div>
    <img src="{{ asset('public/upload/header-logo.jpg') }}" width="100%" style="height:75px">
        ...
        <div style="font-size: 18px;margin-top: 7px;font-weight: bold;text-align: center;"><u ><i>Individual Student Payment Paid Repoet</i></u></div>
           <br>
