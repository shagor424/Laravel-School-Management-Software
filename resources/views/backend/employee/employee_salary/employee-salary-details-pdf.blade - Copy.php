...
<table style="width: 600px;height: 805px">
  ...
  <tr width="Auto"> 
            <td style="font-size: 25px;font-weight: bold; margin-top: 15px" width="100%" valign="middle" align="center">Employee Salary Report</td>
     </tr>
...
<tr width="Auto" width="100%" valign="middle" align="center">
              ...
              <td width="100%" valign="top" align="left">
                ...
                <table class="black10" width="100%" cellspacing="1" cellpadding="2" border="1">
                  <tbody>
                    ...
                    <td style="padding: 8px;font-size: 14px">{{$detailspdf->id_no}} </td>
                  </tr>
                    <tr width="Auto">
                    <th style="padding: 8px;font-size: 14px">Employee Name</th>
                    <td style="padding: 8px;font-size: 14px">{{$detailspdf->name}} </td>
                  </tr>
                  </tr>
                    <tr width="Auto">
  ...
  <tr width="Auto">
     ...
     <td style="font-size: 16px;font-weight: bold; padding: 10px" width="50%" valign="middle" bgcolor="#EAEAEA" align="left">
    <span class="black11">Salary Information<span></span></span></td>
      </tr>
  </tr>
 ...
 <tr width="Auto">
    <td valign="top" bgcolor="#FFFFFF" align="left">
      <table class="table table-bordered" cellpadding="5">
                  <thead>
                    <tr width="Auto" width="100%" valign="top" align="left" style="font-size: 16px;padding: 10px">
                      <th style="padding: 8px;font-size: 14px">SL</th>
                      <th style="padding: 8px;font-size: 14px">Employee ID</th>
                      ...
                      <th style="padding: 8px;font-size: 14px">Effected Date</th>
                    </tr>
                  </thead>
                  <tbody>
                    @foreach($salary as $key=>$value)
                    <tr width="Auto" width="100%" valign="top" align="left" style="font-size: 16px;padding: 10px" >
                      <td style="padding: 8px;font-size: 14px" style="text-align: center;" >{{$key+1}}</td>
                      <td style="padding: 8px;font-size: 14px" style="text-align: center;" >{{$detailspdf->id_no}}</td>
                      <td style="padding: 8px;font-size: 14px">{{$detailspdf->name}}</td>
                      <td style="padding: 8px;font-size: 14px" style="text-align: center;">{{date('d-M-Y',strtotime($detailspdf->join_date))}}</td>
                      <td style="padding: 8px;font-size: 14px" style="text-align: center;">{{$value->previous_salary}}</td>
                      <td style="padding: 8px;font-size: 14px" style="text-align: center;">{{$value->increment_salary}}</td>
                      <td style="padding: 8px;font-size: 14px" style="text-align: center;">{{$value->present_salary}}</td>
                      <td style="padding: 8px;font-size: 14px" style="text-align: center;">{{date('d-M-Y',strtotime($value->effected_date))}}</td>
