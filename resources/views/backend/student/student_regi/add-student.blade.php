            ...
            <div class="card-body" style="background-color:#E6E6E6">
              ...
              <form method="post" action="{{(@$editdata)?route('students.regi.update',$editdata->student_id):route('students.regi.stores')}}" id="myform"enctype="multipart/form-data">
                ...
                <div class="form-row">
                  ...
                  <div class="form-group col-md-4">
                    <label>Email </label>
                    <input  type="email" name="email" id="email" value="{{@$editdata['student']['email']}}" class="form-control" placeholder="Enter Student Email">
                  ...
                  <div class="form-group col-md-4">
                    ...
                    <input class="datepicker"  type="text" name="dob" placeholder="yyyy-mm-dd" id="dob"value="{{@$editdata['student']['dob']}}" class="form-control">
                 ...
                 <div class="form-section col-md-4">
                    <label for="section_id"> Section Name <font style="color: red">*</font></label>
                ...
                <button type="submit"class="btn btn-block bg-gradient-primary float-right">{{(@$editdata)?'Update Student Registration':' Student Registration'}}</button>
