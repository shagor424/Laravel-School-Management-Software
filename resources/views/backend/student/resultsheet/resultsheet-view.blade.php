  ...
  <div style="background-color: #A4A4A4" class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="color:  #117a65"><strong>Manage  Result Sheet</strong></h3>
          </div><!-- /.col -->
        <div class="col-sm-6">
...
;color: black" class="card-header">
                <h5 style="color:  black "><b>Result Sheet</b>
                  
                </h5>
              </div> 
              <div class="card-body">
                <form method="get" action="{{route('marksheets.resultsheet.get')}}" id="myform" target="_blank">
                ...
                <div class="form-group col-md-3" style="margin-top: 30px;">
                   <button  type="submit" class="btn btn-success"> All Student Result Sheet</button>
                  </div>
                </form>
              </div>
