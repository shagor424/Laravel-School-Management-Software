  ...
  <div style="background-color: #A4A4A4" class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="color:  #117a65"><strong>Manage Registration Fee</strong></h3>
          </div><!-- /.col -->
        <div class="col-sm-6">
...
;color: black" class="card-header">
                <h5 style="color:  black "><b>Registration Fee</b>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group col-md-2" style="margin-top: 30px">
                    <a id="search" class="btn btn-danger btn-sm"> Students Search</a>
  ...
  $(document).on('click','#search',function(){
    ...
    if(section_id == ''){
     ...
     if(year_id == ''){
      ...
      $.ajax({
        url: "{{route('students.regifee.getsstudent')}}",
        type: "get",
