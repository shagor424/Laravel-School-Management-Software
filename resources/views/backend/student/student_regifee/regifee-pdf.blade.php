@php
$regifee = App\Model\FeeAmount::where('fee_catagory_id','2')->where('class_id',$details->class_id)->first();
...
<tr width="Auto" width="100%" valign="middle" align="center">
    <td valign="middle" bgcolor="#FFFFFF" align="left">
      ...
      <tbody align="center">
              ...
              <tr width="100%">
                <td colspan="3" style="font-size: 16px;font-weight: bold; padding: 10px" width="100%" valign="middle" bgcolor="#EAEAEA" align="center">Student Registration Fee PaySlip</td>
 </tr>
 ...
 <tr width="100%">
          ...
          <tr width="100%">
            ...
            <tr width="100%">
              <th style="padding: 2px;font-size: 12px" valign="middle" align="left">Registration Fee</th>
