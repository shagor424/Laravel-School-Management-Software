  ...
  <div style="background-color: #A4A4A4" class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h3 style="color:  #117a65"><strong>Manage Bus Fair Fee</strong></h3>
          </div><!-- /.col -->
        <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="index.php">Home</a></li>
              <li class="breadcrumb-item active">Bus Fair Fee</li>
            </ol>
          </div>
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
;color: black" class="card-header">
                <h5 style="color:  black "><b>Bus Fair Fee</b>
  ...
  $(document).on('click','#search',function(){
    ...
    if(section_id == ''){
     ...
     if(year_id == ''){
      ...
      $.ajax({
        url: "{{route('students.busfairfee.getsbusfairfee')}}",
        type: "get",
