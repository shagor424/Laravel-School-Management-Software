          ...
          <section class="col-md-12">
           ...
           <div class="card">
              ...
              <div class="card-body" {{-- style="background-color:#E6E6E6" --}}>
                ...
                <br>
                  <div>
                   <button type="submit" class="btn btn-success float-right">Marks Update</button>
                  </div>
                </form>
              </div>
...
<script type="text/javascript">
  $(document).on('click','#search',function(){
    ...
    if(exam_type_id == ''){
      ...
      $.ajax({
        url: "{{route('marks.getmarks')}}",
        type: "GET",
     data: {'class_id': class_id,'group_id': group_id,'section_id': section_id,'shift_id':shift_id,'year_id':year_id,'assign_subject_id':assign_subject_id,'exam_type_id':exam_type_id},
