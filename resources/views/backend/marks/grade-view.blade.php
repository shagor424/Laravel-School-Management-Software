           ...
           <div class="card">
              <div class="card-header">
                <h5 style="color:  #FF5733 "><b>Grade Point List </b>
                  <a  href="{{route('marks.grade.add')}}" class="btn btn-success btn-sm float-right"><i class="fa fa-plus-circle"> Add Grade Point</i></a>
                </h5>
              </div> 
            <div class="card-body">
                <table id="example1" class=" table-sm table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <a title="Edit" href="{{route('marks.grade.edit',$value->id)}}" class="btn btn-success btn-sm"><i class="fa fa-edit"></i></a>
                    <a title="Delete" id="delete" href="{{route('marks.grade.delete',$value->id)}}" data-token="{{csrf_token()}}" data-id="{{$value->id}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
