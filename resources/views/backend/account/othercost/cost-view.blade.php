          ...
          <section class="col-md-12">
           ...
           <div class="card">
              <div class="card-header">
                <h5 style="color:  #FF5733 "><b>Other Cost List </b>
                  <a  href="{{route('accounts.cost.add')}}" class="btn btn-success btn-sm float-right"><i class="fa fa-plus-circle"> Add Other Cost</i></a>
                </h5>
              </div> 
            <div class="card-body">
                <table id="example1" class=" table-sm table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <td style="text-align: center;"><img style="width: 50px;height: 60px" class="profile-value-img img-fluid"
                      ...
                      <td>
                    <a title="Edit" href="{{route('accounts.cost.edit',$value->id)}}" class="btn btn-primary btn-sm"><i class="fa fa-edit"></i></a>
                    <a title="Delete" id="delete" href="{{route('accounts.cost.delete',$value->id)}}" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
                      </td> 
