...
class StudentProfileController extends Controller
{
    ...
    return view('student.profile.view-profile',compact('user'));

   }
   public function edit(){
     $id = Auth::user()->id;
     $editdata = User::find($id);
     return view('student.profile.edit-profile',compact('editdata'));
   ...
   public function update(Request $request){
        ...
        $data->save();
      return redirect()->route('student.profiles.view')->with('success','Profile Updated Successfully');

        }

        public function passwordview(){

        return view('student.profile.edit-password');
