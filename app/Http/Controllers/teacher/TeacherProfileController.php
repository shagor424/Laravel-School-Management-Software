...
class TeacherProfileController extends Controller
{
    ...
    return view('teacher.profile.view-profile',compact('user'));

   }
   public function edit(){
     $id = Auth::user()->id;
     $editdata = User::find($id);
     return view('teacher.profile.edit-profile',compact('editdata'));
   ...
   public function update(Request $request){
        ...
        $data->save();
      return redirect()->route('teacher.profiles.view')->with('success','Profile Updated Successfully');
